...
The tracked suite contains **1286 tests** as of v1.1.31. Remove diagnostic/development-only tests after features stabilize; keep only tests that exercise unique production paths.
