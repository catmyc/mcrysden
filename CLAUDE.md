...
The tracked suite contains **642 tests** as of v1.1.32. Remove diagnostic/development-only tests after features stabilize; keep only tests that exercise unique production paths.
