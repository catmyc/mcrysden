...
The tracked suite contains **1247 tests** as of v1.1.29. Remove diagnostic/development-only tests after features stabilize; keep only tests that exercise unique production paths.
