...
final class PowderXRDTests: XCTestCase {
    ...
    func testXRDPeakPositionsMultiplicityAndAbsences() {
        let a: Float = 5.6402
    ...
    func testXRDWavelengthFormFactorsAndMultiplicityRules() {
        let a: Float = 5.6402
        let naclCell = Cell(a: SIMD3(a, 0, 0), b: SIMD3(0, a, 0), c: SIMD3(0, 0, a))
        let nacl = [
            Atom(coord: SIMD3(0, 0, 0), atomicNumber: 17, label: "Cl"),
    ...
    func testXRDElectronDensityProjection() {
        let a: Float = 5.0
    ...
    func testXRDFiniteParamsAndExplicitOpMerging() {
        let a: Float = 5.0
        let cell = Cell(a: SIMD3(a, 0, 0), b: SIMD3(0, a, 0), c: SIMD3(0, 0, a))
