...
- The tracked suite contains 33 tests. Keep at most 64 focused tests; consolidate or replace a lower-value case before adding new coverage. When approaching the cap, prefer merging related lower-value cases into broader consolidated tests.
